...
model = load_checkpoint('Hasil\Model\\S2_NLLB.pt', model)
model.eval()
...
test_df = pd.read_csv("S2/Testing_Data/BT_NLLB.csv")  # Sesuaikan dengan file test Anda
...
for sent in test_df['backtranslated_tweet']:
...
predicted_csv_path = os.path.join("Hasil/Predictions", "predicted_S2_NLLB.csv")
...
confusion_matrix_path = os.path.join("Hasil/ConfusionMatrix", "cf_matrix_S2_NLLB.png")
...
classification_report_path = os.path.join("Hasil/ClassificationReport", "clsf_report_S2_NLLB.csv")
