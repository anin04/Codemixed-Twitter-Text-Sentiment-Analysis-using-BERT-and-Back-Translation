...
# Load data dari CSV
train_df = pd.read_csv("Training_Data/BT_Google.csv")
val_df = pd.read_csv("Validation_Data/BT_Google.csv")
...
for epoch_i in range(epochs):
    ...
    if best_valid_loss > avg_val_loss:
        ...
        save_checkpoint("Hasil/Model/model_Google.pt", model, best_valid_loss)
    
    # Simpan data training ke CSV setiap selesai 1 epoch
    save_training_data_to_csv("Hasil/Metrics/metrics_Google.csv", training_stats)
