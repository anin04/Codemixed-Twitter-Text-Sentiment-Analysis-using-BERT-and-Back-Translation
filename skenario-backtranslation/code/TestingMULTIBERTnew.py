...
model = load_checkpoint('Hasil\Model\\S3_mono_english.pt', model)
model.eval()
...
test_df = pd.read_csv("bt3 mono - test.csv")  # Sesuaikan dengan file test Anda
...
predicted_csv_path = os.path.join("Hasil/Predictions", "predicted_S3_mono_english.csv")
...
confusion_matrix_path = os.path.join("Hasil/ConfusionMatrix", "cf_matrix_S3_mono_english.png")
...
classification_report_path = os.path.join("Hasil/ClassificationReport", "clsf_report_S3_mono_english.csv")
